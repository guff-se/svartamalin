...
- Lagskatter: [`../huvudstory/lagskatter.md`](../huvudstory/lagskatter.md). I `crews/`: egen kort göm-intrig, sedan jakten. Ingången (första ledtråden, inskickad av gömmarna) skrivs in i **jagarens** lagfil. Cirkeln och vem som jagas står inte i gästtext.
