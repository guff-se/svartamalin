...
- **Lagintriger** (`crews/{id}.md`): första stycket är oförrätt mot Malin plus generell varför till huvudjakten (låst kista, ta reda på hennes berättelse tillsammans). Andra stycket är lagskatt: gömma vid ankomsten, sedan jakten på den andra skutan med ingång. Social dörr (personen som släpper nästa steg) skrivs **inte** i lagfilen, bara i den personens `guests/`.
...
23. Är det en **lagskatt-ingång** i `crews/`? Då bara första ledtråden, inskickad av gömmarna, skriven in hos jägarna. Inte var skatten ligger. Inte resten av spåret. Inte cirkeln. Inte vem som jagar dem. Inte "spelet", inte att jakten väntar till lördagen. Fysisk (plats, föremål) eller social (namngiven person och metod). **Social dörr:** kort intrig i **den personens** `guests/`, inte i lagfilen. Om hen utpressas, fjäskas eller bjuds: släpp nästa ledtråd. Inte vem som jagar. Inte ledtråd två. Fysisk dörr (brev): en mening i gömmarens lagfil. Se [`../huvudstory/lagskatter.md`](../huvudstory/lagskatter.md) Ingång.
