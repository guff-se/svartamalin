...
23. Är det en **lagskatt-ingång** i `crews/`? Då bara första ledtråden, inskickad av gömmarna, skriven in hos jägarna. Inte var skatten ligger. Inte resten av spåret. Inte cirkeln. Inte vem som jagar dem. Fysisk (plats, föremål) eller social (namngiven person och metod). **Social dörr:** kort intrig i **den personens** `guests/`, inte i lagfilen. Om hen utpressas, fjäskas eller bjuds: släpp nästa ledtråd. Inte vem som jagar. Inte ledtråd två. Fysisk dörr (brev): en mening i gömmarens lagfil. Se [`../huvudstory/lagskatter.md`](../huvudstory/lagskatter.md) Ingång.
