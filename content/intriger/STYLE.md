...
Tekniskt filformat: se [README.md](README.md).
...
| `**Kapten Blod**` / `**Kapten Träben**` | Civilnamn (“Gustaf”, “Malin Tadaa”) i intrigtext |
...
- **Lagintriger** (`crews/{id}.md`): gemensamma uppdrag + hur laget står mot andra lag.
...
3. Finns minst en konkret relation, skuld, hemlighet eller uppdrag med udd?
4. Omnämns alla deltagare **bara** med piratnamn (inga civilnamn)?
5. Spoilar texten Malin/Ran-slutet eller sista versens utgång? → stryk.
6. Kan det mata fredagens leenden, lördagens svek eller kvällens kaos?
7. Finns (gärna) eko från `svartamalin-sångtext.txt` — utan att spoila?
8. Är speglade intriger uppdaterade (eller enväg markerad i frontmatter)?
