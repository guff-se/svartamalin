...
- **Lagintriger** (`crews/{id}.md`): första stycket är oförrätt mot Malin plus generell varför till huvudjakten (låst kista, ta reda på hennes berättelse tillsammans). Andra stycket är **gömma** den egna skatten (kort intrig, dörren öppen). Tredje är **jakten** på den andra skutan, med ingång.
...
23. Är det en **lagskatt-ingång** i `crews/`? Då bara första ledtråden, inskickad av gömmarna, skriven in hos jägarna. Inte var skatten ligger. Inte resten av spåret. Inte cirkeln. Inte vem som jagar dem. Fysisk (plats, föremål) eller social (namngiven person och metod). **Gömmarens** lagfil: egen kort `##`-intrig, inte bara en mening i jaktstycket. Social: personen på skutan ska kunna släppa nästa steg, inte stängas ute. Se [`../huvudstory/lagskatter.md`](../huvudstory/lagskatter.md) Ingång.
