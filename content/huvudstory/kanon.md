...
Detta är givet av Povel Ramels text och kan inte ändras.
...
7. Festen urartade till slagsmål med värjor och krut. Man flög på jubilaren.
8. Malin försvarade sitt namn, smög bort från valplatsen, och resten låg kvar i en hög.
9. Malin är alltid den som står rycken.
...
1. På ön står en kista, väl synlig. Den sägs innehålla Svarta Malins skatt (treasure).
...
5. Cryptexens lösenord är `HKHXII` (Hans Kungliga Höghet XII). Antaget 2026-08-25. Varje ledtråd är en token: siffra plus bokstav. Siffran är positionen. De tre första (`1H`, `2K`, `3H`) delas ut i questen före 15.30. Tagbara tokens bär andra raden `Hon bär 4, 5 och 6.` De tre sista (`4X`, `5I`, `6I`) sitter på Malins berlock, som hon sätter på under peak kl. 17.00. De syns då som bild, inte som pusseljakt. De dialas in när hon serverar kaviar och rom 20.00. Cryptexen kommer in vid lunchen 14.00: Malin har den med sig. Fördelning per quest: [`quests.md`](quests.md). Lösenordet går inte att kläcka utan berlocken. Inte MALINS, SKATT, PIRAT, KUNGEN, KISTAN, KARLXII, eller något från sången, ön, Malins namn eller kontraktets parter. Inte ett ord som sitter ihop med fem av sex bokstäver. Inte en sista ledtråd som bara bekräftar. Om kistan är stängd 20.45 tvingas den upp i roll. Runtime: [`spelledning.md`](spelledning.md).
6. I kistan finns ingen skatt (treasure). Där ligger brev mellan Malin och kungen, plus minnen och skatter (treasure, dressing), plus **tre skuldbrev** (Q-5, ett per manlig start, namn vid tillsättning), plus **en orderlapp** (K-11): konfrontera Malin när hon kallar till kaptensskål. Tändningens innehåll är kärleksbrevet från Karl XII till Svarta Malin. Brevet *är* kontraktet. Inget separat juridiskt papper för tändningen. Lappen är ordern att flyga på henne vid kaptensskålen, inte under serveringen före. Övriga brev, miniatyr, de tre skuldbreven och skatter (treasure, dressing) är dressing. Trycktext: [`../rekvisita/kista-karleksbrev.md`](../rekvisita/kista-karleksbrev.md), [`../rekvisita/kista-konfrontera.md`](../rekvisita/kista-konfrontera.md), [`../rekvisita/kista-skuldbrev.md`](../rekvisita/kista-skuldbrev.md).
...
5. Ingen poäng. Funnen skatt (treasure) får bäras, mutas, stjälas tillbaka. Drama vinner vid krock med huvudstoryn.
6. Sovplatser är inte gömställen. Malins kista är inte gömställe för lagskatt (treasure).
...
|-------|------|----------|
| Vems båt? | TBD | |
| Vad förvaras där? | TBD | |
| Vem har rätt att gå ombord? | TBD | |
...
| Vad är hon skyldig, och vem? | Ingenting. Hon är inte skuldsatt. Hon är trött på att vara Svarta Malin och på att kämpa om Salmonellahavet. Brevet i kistan ger ensam makt och belöning mot förräderiet. Hon ligger med kungen. | 2026-08-23 |
...
| Hur fick hon ön? | Öppen. Låg i Q-4 till 2026-08-24. Q-4 är längtan till Salmonellahavet, ung, före kärleken. Ovanan är hennes hamn. Får inte sägas som fälla i gästtext. | öppen |
| Älskar hon havet? | Q-4. Som ung. Salmonellahavet och friheten. Före Otto. Före sveket. Hon tittar. Kikaren är metaforen. Får vara sant. Inte Q-1 (person). Inte Q-5 (skulder). | 2026-08-24 |
| Hur ser hennes dagbok ut? | En bok i Storstugan, synlig, de flesta sidorna utrivna. Stubbar kvar. Inga kapitel i pärmen. De utrivna bladen är questfynd och bär talet Blad N i tidsordning, inte i questordning. Översikt: [`dagbok.md`](dagbok.md). | 2026-08-24 |
