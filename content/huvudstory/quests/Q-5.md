...
**Håll isär från:** Kistans kärleksbrev (plot). De tre skuldbreven är Q-5:s payoff, inte tändningen. [`Q-3.md`](Q-3.md) (belöningen av Kurtisanen syns inte här). [`Q-1.md`](Q-1.md) (hemligheter ur sängen, inte en bok). [`Q-4.md`](Q-4.md) (kärleken till havet, inte skulderna). Temat i [`../premiss.md`](../premiss.md): att sälja rollen man tröttnat på.
