...
**Tillsättning (2026-08-24):** Skuta 1, 3, 5. Start: Kapten Lösskägg (`petterwallberg`), Kapten Nykter (`fabianmacklin`), Kapten Dunka (`ludvigvonbahr`). Skuta 2 och 4 har ingen ingång till Q-5. Tvärledtråd: Kapten Blodig (`minimacklin`, skuta 2), Kapten Rödskägg (`viktoransund`, skuta 4). Ingen av de fem är Malin eller Spader. Deras tre skuldbrev i kistan (K-10) namngivna i [`../produktion.md`](../produktion.md). Gästtext oskriven, se `fordelning.yaml` id 74-78.

Balans mot Q-4 (ännu utan form): efter Q-1, Q-2 och Q-5 behöver skuta 1 en tredje quest-start, skuta 2 två, skuta 3 ingen mer (redan på tre: Q-1, Q-2, Q-5), skuta 4 två, skuta 5 en. Q-3 form låst, inte tillsatt. Skuta 3 ska inte tillsättas Q-3 eller Q-4 som start.
