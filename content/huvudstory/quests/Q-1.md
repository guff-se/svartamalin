...
**Tillsättning (2026-08-23):** Skuta 1, 3, 5. Start: Kapten Planka (`linneaappert`), Kapten Frodig (`josefinansund`), Kapten Plåthorn (`elinmartensson`). Inte Hjärter eller Blodig (S-01 kolliderar, se ovan). Skuta 2 och 4 har ingen ingång till Q-1. Gästtext skriven och klar (2026-08-24): id 63-65 i [`../fordelning.yaml`](../fordelning.yaml) satta till `done`. Planka är Kurtisanen (skuta 1, Malins egen skuta): hennes gästtext bär regel 8 i [`../quests.md`](../quests.md), hon jagar bladen utan att Malin ser.
