...
| id | Prop | Används i | Måste vara | Ansvarig | Deadline | Status |
|----|------|-----------|-----------|----------|----------|--------|
| K-01 | Malins kista, låsbar med nyckel | B-01, B-41, B-42 | Väl synlig, tåla väder om den står ute, se ut som skattkista, gå att öppna med en nyckel inför 25 personer | | | saknas |
...
| LS1-01 | Siffror från kurtisanens kaptener, Kurtisanens ingång | B-11 | Social. Ingen utläggning. Dörren är alla fem ombord, inklusive Malin: **Svarta Malin** (`malintadaa`), **Kapten Lösskägg** (`petterwallberg`), **Kapten Planka** (`linneaappert`), **Kapten Barnsben** (`ulrikahammar`), **Kapten Hurring** (`jesperlindmarker`). En siffra var. Siffrorna är lagets. Inte vår tryck. Var och en ska veta sin siffra. | Kurtisanen (siffror) | lör 10.30 | lagets |
