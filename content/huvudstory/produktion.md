...
| K-10 | Tre skuldbrev | B-42, Q-5 | Ett per Q-5-start. Tillsatt 2026-08-24: Kapten Lösskägg (`petterwallberg`), Kapten Blåskägg (`hampuslindblad`), Kapten Dunka (`ludvigvonbahr`). Dressing, inte plot. Text: [`../rekvisita/kista-skuldbrev.md`](../rekvisita/kista-skuldbrev.md). | | | utkast |
