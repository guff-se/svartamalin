...
Kopiera för varje beat. Fyll i allt. Ett tomt fält betyder att beaten inte är klar.
...
Tid:            ca kl.
Plats:          
Inblandade:     Piratnamn (slug), ...
Publik:         vilka andra ser det hända

Vad händer:     en till tre meningar, rakt på

Vad ändras:     vad är sant efteråt som inte var sant innan

Trigger:        vad sätter igång beaten
Väg 1:          hur deltagarna kan nå den själva
...
Här ligger tyngden. Escape-mekanik och en gemensam tävlingsliknande aktivitet parallellt, medan bollen läggs upp för eftermiddagen.

Vad akt II måste åstadkomma:
...
Inblandade:     Skuta 1 (Korvetten Kurtisanen), Skuta 3 (Barken Bortförklaringen), Skuta 5 (Galeonen Gnället). Start: Kapten Lösskägg (`petterwallberg`), Kapten Nykter (`fabianmacklin`), Kapten Rötägg (`edvinthungren`). Tvärledtråd: Kapten Blodig (`minimacklin`, skuta 2), Löjtnant Spader (`gustaftadaa`, skuta 2, undantag regel 9/13), Kapten Rödskägg (`viktoransund`, skuta 4). Inte Malin.
...
## Akt III: Ritualen (lördag 15.30)

Se [`ritual.md`](ritual.md) för koreografin. Här beskrivs bara vad ritualen betyder för berättelsen.

Vad akt III måste åstadkomma:

- [ ] Ge ett fiktivt skäl till att alla samlas samtidigt
- [ ] Förklara varför spelets natur byter karakter efteråt, alltså från pussel till kropp
- [ ] Avslöja eller bekräfta en del av den centrala sanningen, i bild snarare än i text
- [ ] Skapa en gemensam skuld eller ett gemensamt löfte som slutstriden kan bryta
...
## Akt IV: Förlisning (lördag 20.00)

Se [`slutstriden.md`](slutstriden.md). Minimal ny mekanik. Allt som byggts ska få explodera.
...
Props:          kärleksbrevet (K-07, trettio sekunder högt). Orderlapp K-11: konfrontera Malin när hon kallar till kaptensskål. Dressing: övriga brev, minnen, skatter, miniatyr (K-06, K-08).
...
Den centrala sanningen delas i bitar. Varje bit får en rad. Regeln från [`RESEARCH.md`](RESEARCH.md): minst två oberoende vägar plus en spelledarväg.
