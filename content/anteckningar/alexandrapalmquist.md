...
pirate_name: Kapten Babord
real_name: Alexandra Palmquist
---
...
Lagskatt: hon är en av fem dörrar. Minst tre av galeonen samlade plus stormraden. Påminnelse i `guests/alexandrapalmquist.md`. Mullvaden säljer gömställe, inte den här dörren. Se [`../huvudstory/lagskatter.md`](../huvudstory/lagskatter.md).
