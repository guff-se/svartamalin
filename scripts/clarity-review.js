...
- Svarta Malin's secret lover: the identity is a secret Malin already knows. The name must not appear in guest text. Do not flag that the lover is unnamed, for Malin or for anyone hunting the name. There is no planted decoy after Dunka's cancellation.
...
4. Referenced event without retelling. The text names a past incident by its outcome, excuse, or nickname, but never tells the scene. The character was supposedly there; the player was not. Ask: can I, from these three files alone, say WHAT happened — who did what to whom, with what? If you only have a result ("tappade värdigheten"), a cover story ("svurit att det var något annat"), or a label ("det gamla sveket") without the incident, flag it.
   Example: "Hon tappade värdigheten vid förra kaptensskålen och har sen dess svurit att det var något annat." You know dignity was lost and there is an excuse. You do not know what was done to her at the toast. Flag the untold incident even if you already flagged "kaptensskålen" as definite form. Naming the occasion is not the same as retelling the event.
