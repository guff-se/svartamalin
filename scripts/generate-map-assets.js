...
const ASSETS = [
  ...
  },
  {
    file: 'globen.png',
    prompt:
      'A naïve hand-drawn sketch of Globen (the Ericsson Globe arena) in Stockholm, Sweden, for an 18th-century travel map by an unskilled amateur cartographer who has heard of this strange round building but cannot draw it well. Quill pen and iron-gall ink with muted grey-brown watercolour wash spilling outside the outlines. A large lopsided sphere or dome — not quite round, more potato-shaped — with wobbly horizontal panel lines, a crooked cylindrical base or pedestal underneath, maybe a tiny stick-figure flag poking off at a wrong angle. CRITICAL — HOOLIGANS: a rowdy crowd of five or six BIG chunky hooligans gathered around the base of Globen, drawn in the EXACT same simple folk-art style as highway robbers on a map — thick quill outlines, flat muted rust-red and olive-green washes, angry scowling dot-eyes, open shouting mouths, tricorn or flat caps, raised fists, one waving a crooked bottle, one with a bent club or stick, lopsided sausage bodies. Each hooligan should be LARGE — roughly half the height of the globe sphere, as tall as the pedestal base or taller, chunky and prominent in the composition, not tiny stick figures. They mob and crowd the pedestal, taking up the whole lower third of the image. CRITICAL STYLE: as simple and flat as robbers.png — bold outlines, flat colour blobs, no cross-hatching, no realistic crowd, no modern photo style. Proportions all wrong, perspective broken. CRITICAL FRAMING: entire scene (globe + hooligans) fits inside the image with generous transparent margin on all sides, nothing cropped. Period sepia palette, aged and oxidised. Isolated map decoration only.',
  },
  {
    file: 'arrow-down.png',
    size: [128, 256],
  ...
  },
  {
    ...
    prompt:
      'A naïve hand-drawn pirate ogre map sticker in the EXACT same visual style as a highway-robbers map decoration — the same thick quill-pen outlines, same flat muted watercolor washes spilling outside the lines, same folk-art simplicity. By an unskilled amateur cartographer who cannot draw well. ONE single ogre figure only, standing front-facing, chunky and lopsided like a clumsy doodle. Muted olive-green flat skin wash (no bumps, no warts, no texture). Head too big, one tusk as a simple white triangle, angry scowling face drawn like the robbers — two mismatched dot-eyes, angry scribble eyebrows, rectangular open mouth with a few vertical tooth lines. CRITICAL — SHABBY OGRE PIRATE CLOTHES: everything he wears is stolen, too small, and falling apart — a crooked tricorn hat crushed and bent with a torn brim, a rust-red frock coat much too tight on his huge shoulders with jagged torn hem and sleeves, missing buttons and one sleeve shorter than the other, a dirty off-white shirt sticking out in ragged tufts, a loose belt slung low on a fat belly, one patched brown breeches leg and one bare green stubby leg, one enormous scuffed boot bursting at the seams and one bare ogre foot with thick toes. Bent cutlass in one sausage hand. Quill pen and iron-gall ink, muted rust-red, olive green, sepia and black-brown wash only. CRITICAL STYLE: as simple and flat as robbers.png or kraken.png — bold outlines, flat colour blobs, zero cross-hatching, zero skin detail, zero stitching or fabric texture, zero painterly shading, zero storybook illustration, zero realistic monster art. Awkward proportions, earnest but genuinely bad drawing. Map decoration only.',
  },
]
